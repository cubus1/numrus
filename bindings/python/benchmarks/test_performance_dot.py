...
# Function to perform dot product using numrus
def dot_numrus(a, b, dtype):
...
@pytest.mark.parametrize(
    "func,dtype,size",
    [
        (dot_numrus, "float32", 1000),
        (dot_numrus, "float64", 1000),
        (dot_numpy, "float32", 1000),
        (dot_numpy, "float64", 1000),
        (dot_numrus, "float32", 10000),
        (dot_numrus, "float64", 10000),
