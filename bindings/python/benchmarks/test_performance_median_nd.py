...
# Function to perform median using numrus
def median_numrus(a, dtype):
...
@pytest.mark.parametrize(
    "func,dtype,size",
    [
        (median_numrus, "float32", 1000),
        (median_numrus, "float64", 1000),
        (median_numpy, "float32", 1000),
        (median_numpy, "float64", 1000),
        (median_numrus, "float32", 10000),
        (median_numrus, "float64", 10000),
