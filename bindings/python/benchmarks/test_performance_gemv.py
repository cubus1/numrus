...
# Function to perform gemv product using numrus
def gemv_numrus(a, b, size, dtype):
...
@pytest.mark.parametrize(
    "func,dtype,size",
    [
        (gemv_numrus, "float32", 1000),
        (gemv_numrus, "float64", 1000),
        (gemv_numpy, "float32", 1000),
        (gemv_numpy, "float64", 1000),
        (gemv_numrus, "float32", 10000),
        (gemv_numrus, "float64", 10000),
