...
# Function to perform gemm using numrus
def gemm_numrus(a, b, size, dtype):
...
@pytest.mark.parametrize(
    "func,dtype,size",
    [
        (gemm_numrus, "float32", 500),
        (gemm_numrus, "float64", 500),
        (gemm_numpy, "float32", 500),
        (gemm_numpy, "float64", 500),
        (gemm_numrus, "float32", 2000),
        (gemm_numrus, "float64", 2000),
