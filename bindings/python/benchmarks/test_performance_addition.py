...
# Function to perform addition using numrus
def add_numrus(a, b, dtype):
...
@pytest.mark.parametrize(
    "func,dtype,size",
    [
        (add_numrus, "float32", 1000),
        (add_numrus, "float64", 1000),
        (add_numpy, "float32", 1000),
        (add_numpy, "float64", 1000),
        (add_numrus, "float32", 10000),
        (add_numrus, "float64", 10000),
