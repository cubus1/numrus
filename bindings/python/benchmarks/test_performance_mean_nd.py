...
# Function to perform mean using numrus
def mean_numrus(a, dtype):
...
@pytest.mark.parametrize(
    "func,dtype,size",
    [
        (mean_numrus, "float32", 1000),
        (mean_numrus, "float64", 1000),
        (mean_numpy, "float32", 1000),
        (mean_numpy, "float64", 1000),
        (mean_numrus, "float32", 10000),
        (mean_numrus, "float64", 10000),
