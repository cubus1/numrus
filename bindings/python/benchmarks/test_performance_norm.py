...
@pytest.mark.parametrize(
    "func,dtype,size,p",
    [
        (norm1d_numrus, "float32", 1000, 1),
        (norm1d_numrus, "float64", 1000, 1),
        (norm1d_numpy, "float32", 1000, 1),
        (norm1d_numpy, "float64", 1000, 1),
        (norm1d_numrus, "float32", 10000, 1),
        (norm1d_numrus, "float64", 10000, 1),
        (norm1d_numpy, "float32", 10000, 1),
        (norm1d_numpy, "float64", 10000, 1),
        (norm1d_numrus, "float32", 1000, 2),
        (norm1d_numrus, "float64", 1000, 2),
        (norm1d_numpy, "float32", 1000, 2),
        (norm1d_numpy, "float64", 1000, 2),
        (norm1d_numrus, "float32", 10000, 2),
        (norm1d_numrus, "float64", 10000, 2),
...
@pytest.mark.parametrize(
    "func,dtype,size,p",
    [
        (norm2d_numrus, "float32", (100, 100), 1),
        (norm2d_numrus, "float64", (100, 100), 1),
        (norm2d_numpy, "float32", (100, 100), 1),
        (norm2d_numpy, "float64", (100, 100), 1),
        (norm2d_numrus, "float32", (500, 500), 1),
        (norm2d_numrus, "float64", (500, 500), 1),
        (norm2d_numpy, "float32", (500, 500), 1),
        (norm2d_numpy, "float64", (500, 500), 1),
        (norm2d_numrus, "float32", (100, 100), 2),
        (norm2d_numrus, "float64", (100, 100), 2),
        (norm2d_numpy, "float32", (100, 100), 2),
        (norm2d_numpy, "float64", (100, 100), 2),
        (norm2d_numrus, "float32", (500, 500), 2),
        (norm2d_numrus, "float64", (500, 500), 2),
