...
# Function to perform min using numrus
def min_numrus(a, dtype):
...
@pytest.mark.parametrize(
    "func,dtype,size",
    [
        (min_numrus, "float32", 1000),
        (min_numrus, "float64", 1000),
        (min_numpy, "float32", 1000),
        (min_numpy, "float64", 1000),
        (min_numrus, "float32", 10000),
        (min_numrus, "float64", 10000),
